...
while capture.isOpened():
    ...
    if ret :
        ...
        #スイッチ2(右)が押された場合．
            ...
            print ("turnright")
            #frameから輪郭をとる
            cv2.imshow('img',img_right1)
            cv2.waitKey(500)
            cv2.imshow('img',img_right2)
            cv2.waitKey(500)
            cv2.imshow('img',img_right3)
            cv2.waitKey(500)
            cv2.imshow('img',img_right4)
            cv2.waitKey(800)
        ...
        #スイッチ3(左)が押された場合．
            ...
            cv2.imshow('img',img_left1)
            cv2.waitKey(500)
            cv2.imshow('img',img_left2)
            cv2.waitKey(500)
            cv2.imshow('img',img_left3)
            cv2.waitKey(500)
            cv2.imshow('img',img_left4)
            cv2.waitKey(800)
        ...
        #スイッチ4(stop)が押された場合．
            ...
            print ("stop")
            #frameから輪郭をとる
            cv2.imshow('img',img_stop1)
            cv2.waitKey(500)
            cv2.imshow('img',img_stop2)
            cv2.waitKey(500)
        ...
        #スイッチ5(rest)が押された場合．
            ...
            cv2.imshow('img',img_rest1)
            cv2.waitKey(200)
            cv2.imshow('img',img_rest2)
            cv2.waitKey(2000)
